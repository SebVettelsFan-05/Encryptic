#!/usr/bin/env python3
"""
crypto_uart.py — CLI for FPGA SHA-256 + AES-256 (terminal-friendly protocol).
...
Examples:
    python crypto_uart.py COM4 115200 hash "abc"
    python crypto_uart.py COM4 115200 encrypt mypassword meow.txt secret.enc
    python crypto_uart.py COM4 115200 decrypt mypassword secret.enc recovered.txt
"""
